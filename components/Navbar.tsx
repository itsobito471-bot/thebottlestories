    ...
    <div className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6">
                ...
                {mounted && user ? (
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        size="sm"
                        className="bg-[#1C1C1C] text-[#F8F8F8] hover:bg-[#222222] rounded-full transition-all duration-300 hover:shadow-lg hover:scale-105 px-3 gap-2"
                      >
      ...
      >
        <div className="px-4 py-6 space-y-2">
          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-slate-100/50 mt-2">
             {mounted && user ? (
                <>
                ...
                <Link href="/login" onClick={() => setIsOpen(false)}>
                  <Button className="w-full bg-[#1C1C1C] text-white rounded-full">
                    Login / Sign Up
                  </Button>
                </Link>
             )}
             ...
             <Link href="/cart" onClick={() => setIsOpen(false)}>
               <Button variant="outline" className="w-full rounded-full border-2 border-white/40">
