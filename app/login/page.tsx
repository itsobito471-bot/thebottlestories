...
// --- Icons ---
// Removed Chrome import here
import { Loader2, Facebook, AlertCircle, CheckCircle2 } from 'lucide-react';
            ...
            <motion.div variants={formItemVariants} className="grid grid-cols-1 sm:grid-cols-1 gap-4">
              ...
              >
                {isSocialLoading === 'google' ? (
                  ...
                  <>
                    {/* --- CHANGED: Use new GoogleIcon component --- */}
